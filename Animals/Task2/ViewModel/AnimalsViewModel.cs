...
namespace Task2.ViewModel
{
    public class AnimalsViewModel : INotifyPropertyChanged
    {
        ...
        public AnimalsViewModel()
        {
            ...
            Dog.Voice += (sender, e) => ShowVoiceMessage?.Invoke(this, "Dog barks!");
            Panther.Voice += (sender, e) => ShowVoiceMessage?.Invoke(this, "Panther roars!");
            Panther.ClimbTree += (sender, e) => ShowVoiceMessage?.Invoke(this, "Panther climbed the tree.");
        }
